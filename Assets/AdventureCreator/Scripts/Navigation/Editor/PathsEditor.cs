...
public class PathsEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_target.pathType = (PathType) EditorGUILayout.EnumPopup ("Path type:", (PathType) _target.pathType);
		...
		for (int i=1; i<_target.nodes.Count; i++)
		{
			...
			EditorGUILayout.BeginVertical("Button");
				EditorGUILayout.BeginHorizontal ();
					...
					{
						Undo.RegisterUndo (_target, "Add path node");
					...
					{
						Undo.RegisterUndo (_target, "Delete path node");
